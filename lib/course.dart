...
class Coursepage extends StatelessWidget {
 ...
 return Column(
   children: [
     ListTile(trailing:Icon(icon,color: Color.fromARGB(255, 241, 153, 55)),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient:LinearGradient(
                  ...
                  colors: [Color.fromARGB(255, 89, 89, 89),Color.fromARGB(255, 89, 89, 89)],
                  ...
                  Column(
                    ...
                    children: [
                      CircleAvatar(
                        ...
                        child: Icon(Icons.play_arrow,color: Color.fromARGB(255, 89, 89, 89),),
                               radius: 14.0,  
                             ),
               ...
               children: [               
                    Expanded(
                      ...
                      padding: EdgeInsets.all(20),
                       color: Colors.black,
                       child: Center(child: Text('Jockate Mwangelo' ,style: TextStyle(fontSize: 20.0,color: Colors.white)))
                   ),
                    )  
               ]
             ),
             ...
             //Title of ther course
               ...
               children: [               
                    Expanded(
                      ...
                      padding: EdgeInsets.all(20),
                       color: Colors.black,
                       child: Center(child: Text('LEADERSHIP' ,style: TextStyle(fontSize: 20.0,fontWeight: FontWeight.bold,color: Colors.white)))
                   ),
                    )  
               ]
             ),
                    ...
                    Expanded(
                     ...
                     style: ElevatedButton.styleFrom(
                      ...
                      child: Padding(
                        ...
                        child: Text('PLAY LESSON 1',style: TextStyle(fontSize: 25,color: Colors. black),),
                      ),
                    ),
                   ),
                    ),
